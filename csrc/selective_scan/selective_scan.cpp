...
void set_ssm_params_fwd(SSMParamsBase &params,
    ...
    // retep is here
    params.ssm_initial_state_ptr = ssm_initial_state_ptr;
...
void set_ssm_params_bwd(SSMParamsBwd &params,
    ...
    // retep is here
    params.dssm_initial_state_ptr = dssm_initial_state_ptr;
...
selective_scan_fwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    uint32_t ssm_initial_state_d_stride = 0;
...
selective_scan_bwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    // retep is here
    at::Tensor dssm_initial_state;
    uint32_t dssm_initial_state_batch_stride = 0;
